...
{ 
	set_time_limit(3000); $mysqli = new mysqli($host,$user,$pass,$name); $mysqli->select_db($name); $mysqli->query("SET NAMES 'utf8mb4'"); $mysqli->query("SET time_zone='-00:00'");
...
EXPORT_DATABASE("localhost","root","","mtscdb");
